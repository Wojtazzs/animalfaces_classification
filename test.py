...
print(func.test_single_image(filename="images/BearHead/BearHead_2.jpg", model=svc_m, visualization=False))

print(func.test_single_image(filename="test_img.jpg", model=svc_m, visualization=True))
